...
export const PATIENTS: Patient[] = [
  { id: 1, name: 'LEANDRO SOUSA SOARES', bedNumber: 115, motherName: '-', dob: '2025-05-11', ctd: 'Estável', devices: devices1, exams: exams1, medications: medications1, surgicalProcedures: surgicalProcedures1, cultures: [], scaleScores: [] },
  { id: 2, name: 'MARIA MAITE DA SILVA DE SOUSA', bedNumber: 110, motherName: '-', dob: '2025-10-03', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 3, name: 'SOPHIA SOUSA ALVES', bedNumber: 104, motherName: '-', dob: '2014-01-31', ctd: 'Observação', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 4, name: 'ARTHUR CARVALHO MOURA', bedNumber: 112, motherName: '-', dob: '2017-04-16', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 5, name: 'AVILA MANUELLE NASCIMENTO BRASIL', bedNumber: 4, motherName: '-', dob: '2025-09-18', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 6, name: 'AYLA VALENTINA ALMEIDA BRITO', bedNumber: 98, motherName: '-', dob: '2017-01-26', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 7, name: 'GABRIEL RAVICK LIMEIRA GOMES', bedNumber: 108, motherName: '-', dob: '2016-02-11', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 8, name: 'DAVI EVANGELISTA DA CRUZ', bedNumber: 102, motherName: 'Orcilene Barros', dob: '2019-03-12', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 9, name: 'ELIAS DOS SANTOS SILVA LIMA', bedNumber: 101, motherName: '-', dob: '2024-10-03', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 10, name: 'CARLOS DANIEL COSTA FERREIRA', bedNumber: 45, motherName: '-', dob: '2018-05-06', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 11, name: 'JOSE ALEF SOUSA VILANTE FIALHO', bedNumber: 105, motherName: '-', dob: '2023-10-20', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 12, name: 'NICOLAS EMANUEL BRITO BEZERRA', bedNumber: 113, motherName: '-', dob: '2017-01-31', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 13, name: 'VITORIA DOS MILAGRES SOUSA', bedNumber: 100, motherName: '-', dob: '2020-10-12', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 14, name: 'PABLO GAEL SILVA SANTOS', bedNumber: 106, motherName: '-', dob: '2025-07-18', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 15, name: 'ANNALICY DE MIRANDA OLIVEIRA DA', bedNumber: 107, motherName: '-', dob: '2015-10-06', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 16, name: 'NATANAEL RIKELMY DE AGUIAR LIMA', bedNumber: 99, motherName: 'Francisca da Costa', dob: '2012-06-20', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 17, name: 'MAYLLA LAVINIA SILVA CANTANHEDE', bedNumber: 103, motherName: 'Maria Clara', dob: '2025-08-15', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 18, name: 'DAVILLA HELOYSA CHAVES PEREIRA', bedNumber: 109, motherName: '-', dob: '2020-12-01', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 19, name: 'CAIO EDUARDO DOS SANTOS CAMPOS', bedNumber: 3, motherName: 'Ana paula', dob: '2024-03-09', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 20, name: 'DAVI LUIZ SILVA BRITO', bedNumber: 111, motherName: '-', dob: '2025-04-05', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 21, name: 'ABIMAEL MENDES DA CONCEICAO', bedNumber: 46, motherName: 'MARIA FLORISMAR', dob: '2017-01-09', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
  { id: 22, name: 'MARIA HELOISA SOUSA SILVA', bedNumber: 114, motherName: '-', dob: '2022-05-16', ctd: 'Estável', devices: [], exams: [], medications: [], surgicalProcedures: [], cultures: [], scaleScores: [] },
];
